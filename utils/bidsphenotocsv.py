...
def main(argv):
                                ...
                                for FL in tsv_files:
                                    if FL.endswith('.tsv'):
                                        ...
                                        for c in r_tsv.columns :
                                            ...
                                            #create json term description list
                                            jsonterm = []
                                            ...
                                            tuple1 = list(zip(term_list,d_s,jsonterm))
                        ...
                        for file in files:
                            if file.endswith('.tsv'):
                                ...
                                for col in rtsv.columns :
                                    ...
                                    #create a json term description list
                                    json_d = []
                                    ...
                                    tuple2 = list(zip(termlist,ds,json_d))
    ...
    df.to_csv(args.output_dir+'Openneuro_BIDS_Phenotype_Terms.csv', header = ['Terms','ds_number', 'json description'], index=False)
